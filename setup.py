...
if __name__ == '__main__':
    ...
    setup(
        ...
        project_urls={
            'Documentation': 'https://algoets.github.io/backtesting.py/doc/backtesting/',
            'Source': 'https://github.com/algoets/backtesting.py/',
            'Tracker': 'https://github.com/algoets/backtesting.py/issues',
        },
